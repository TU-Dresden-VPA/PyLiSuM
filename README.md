...
Simulating multiple intersections is supported. Currently, LISA+<sup>®</sup> files are included for only one intersection. Additional provisioning files must be provided by the user for multi-intersection SUMO simulations.
